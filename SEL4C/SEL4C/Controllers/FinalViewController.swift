...
class CustomTransition3: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    override func viewDidLoad() {
        ...
        Task {
            do {
                ...
                titleLabel.text = "Preguntas Finales"
    ...
    @objc func sendButtonTapped() {
        ...
        Task {
            do {
                ...
                do{
                     let newActivityCompleted = NewActivitiesCompleted(activity: 7, entrepreneur: SessionManager.shared.currentUser!.id)
